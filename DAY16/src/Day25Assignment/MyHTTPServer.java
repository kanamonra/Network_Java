...
public class MyHTTPServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        server.createContext("/index", new Day25HTTP.MyHTTPServer.DetailHandler());
    ...
    public static String getResponse() {
        ...
        responseBuffer
                .append("<html><h1>PRODUCT MANAGEMENT.... </h1><br>")
                .append("<b>Welcome to the product management demo version " + "server!</b><BR>")
                .append("</html>");
